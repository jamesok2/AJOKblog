...
if(isset($_POST['Submit'])){
    ...
    if(empty($Title)){
        ...
        global $connection;
        $editId = $_GET['Edit'];
        $updateQuery = "UPDATE admin_panel SET datetime='$DateTime', title = '$Title',
                        category='$Category', author = '$Admin', image='$Image', 
                        post='$Post' WHERE id = '$editId'";

        $execute = $connection->query($updateQuery);
        move_uploaded_file($_FILES["Image"]["tmp_name"],$Target);

        if($execute){
            $_SESSION["SuccessMessage"] = "Post Updated Successful!";
            Redirect_to("dashboard.php");
        }else{
            $_SESSION["ErrorMessage"] = "Update Failed, Please Try Again";
            Redirect_to("dashboard.php");
        }
    }
...
<!--                        <span class="oi oi-comment-square" title="comment-square" aria-hidden="true"></span>&nbsp;Comments</a> </li>-->
        ...
        <div class="col-sm-10"><!-- The second column yielding the main content (right of the sidebar) -->
           ...
           <div>
               ...
               <?php
               $connection;
               $updateParameter = $_GET['Edit'];
               $sqlQuery = "SELECT * FROM admin_panel WHERE id = '$updateParameter'";
               ...
               ?>
               <form action="editpost.php?Edit=<?php echo $updateParameter; ?>" method="post" enctype="multipart/form-data">
                   <fieldset>
                       <div class="form-group">
                           <label for="title"><span class="FieldInfo">Title:</span> </label>
                           <input class="form-control" type="text" name="Title" id="title" value="<?php echo $TitleUpdate; ?>">
                       </div>
                       <div class="form-group">
                           ...
                           <select class="form-control" id="categoryselect" name="Category">
                               ...
                               echo "<option> $CategoryUpdate </option>";
                       ...
                       <div>
                           ...
                           <img src="upload/<?php echo $ImageUpdate; ?>" width="160"; height = "60";>
                       </div>
                       <div class="form-group">
